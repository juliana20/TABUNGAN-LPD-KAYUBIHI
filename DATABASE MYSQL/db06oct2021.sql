...
(1,'10101',NULL,NULL,'Kas Koperasi',0,0,'Aktiva','Aktiva Lancar','Debit'),
(2,'10102',NULL,NULL,'Bank Koperasi',0,0,'Aktiva','Aktiva Lancar','Debit'),
(3,'40101',NULL,NULL,'Pendapatan Koperasi',0,0,'Pendapatan','Pendapatan','Kredit'),
(4,'40102',NULL,NULL,'Pendapatan Lain-lain',0,0,'Pendapatan','Pendapatan','Kredit'),
(5,'20101',NULL,NULL,'Hutang Nasabah',0,0,'Hutang','Hutang Lancar','Kredit'),
(6,'20102',NULL,NULL,'Hutang Lain-lain',0,0,'Hutang','Hutang Lancar','Kredit'),
(7,'30101',NULL,NULL,'Modal',0,0,'Modal','Modal','Kredit'),
(8,'60101',NULL,NULL,'Biaya Gaji Karyawan',0,0,'Biaya','Biaya Operasional','Debit'),
(9,'60102',NULL,NULL,'Biaya Marketing',0,0,'Biaya','Biaya Operasional','Debit'),
(10,'60103',NULL,NULL,'Biaya ATK',0,0,'Biaya','Biaya Operasional','Debit'),
(11,'60104',NULL,NULL,'Biaya Fotocopy',0,0,'Biaya','Biaya Operasional','Debit'),
(13,'60105',NULL,NULL,'Biaya Internet',0,0,'Biaya','Biaya Operasional','Debit'),
(14,'60106',NULL,NULL,'Biaya Listrik dan Air',0,0,'Biaya','Biaya Operasional','Debit');
...
insert  into `tb_mutasi_kas`(`id`,`id_mutasi_kas`,`id_user`,`tanggal`,`jenis_mutasi`,`akun_id`,`total`,`keterangan`,`status_batal`) values 
(2,'MUT-211003-0001','2','2021-10-03 12:00:00','Pengeluaran','10101',900000,'Pengeluaran bulan october',1),
(4,'MUT-211003-0003','2','2021-10-03 12:00:00','Penerimaan','10101',1000000,'-',0),
(3,'MUT-211003-0002','2','2021-10-03 12:00:00','Pengeluaran','10102',250000,'Pengeluaran bank',0);
...
insert  into `tb_mutasi_kas_detail`(`id`,`id_mutasi_kas`,`akun_id`,`keterangan`,`nominal`) values 
(1,'MUT-211003-0001','60102','-',300000),
(2,'MUT-211003-0001','60103','Beli Kertas',600000),
(3,'MUT-211003-0002','60104','Fotocopy berkas nasabah',250000),
(4,'MUT-211003-0003','40101','Denda Nasabah',1000000);
...
insert  into `tb_pinjaman`(`id`,`id_pinjaman`,`tgl_realisasi`,`id_user`,`id_nasabah`,`no_rek_tabungan`,`jaminan`,`jangka_waktu`,`jatuh_tempo`,`jumlah_pinjaman`,`biaya_materai`,`biaya_asuransi`,`biaya_lainnya`,`propisi`,`jumlah_diterima`,`angsuran`,`sisa_pinjaman`,`sisa_bunga`,`id_akun`,`saldo_tabungan`,`bunga_pinjaman`,`nominal_bunga`,`menetap`,`lunas`) values 
(7,'KR30092021001','2021-09-30','1','NS001','TB2109150001','Sertifikat tanah','12','2022-09-30',10000000,10000,0,0,0,9990000,933333,0,0,'10101',400000,0.01,1200000,1,1);
...
(7,'KR30092021001','2021-09-30',1,833333,100000,0,'10101',933333,10266700,1100000,1),
(8,'KR30092021001','2021-09-30',1,9166670,1100000,0,'10101',10266700,0,0,1);
...
(4,'TTB16092021151','1','NS001','TB2109150001','2021-09-16',NULL,200000,300000,'10101',1,0),
(5,'TTB16092021161','1','NS001','TB2109150001','2021-09-16',100000,NULL,200000,'10101',1,0),
