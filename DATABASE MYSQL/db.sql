...
insert  into `tb_kategori_keuangan`(`id`,`nama_kk`,`jenis_kk`,`status_kk`) values 
(1,'Pembayaran SPP','Pembayaran','Aktif'),
(2,'Pembayaran Gedung','Pembayaran','Aktif'),
(3,'Pengeluaran Lainnya','Pengeluaran','Aktif'),
(4,'Pemasukan Lainnya','Pemasukan','Aktif');
