...
var dev_forms = {
    ...
    /* ./default form functions */
        ...
        /* bootstrap select */
        if($(".selectpicker").size()){
            $(".selectpicker").selectpicker();        
		}
		/* ./bootstra select */
		
        /* bootstrap datepicker */
        if($("input.datetimepicker").size()){
        ...
        if($("input.timepicker").size()){
            $("input.timepicker").datetimepicker({format: "HH:mm"});
		}
		
        if($("input.datepickeryears").size()){
            $("input.datepickeryears").datetimepicker({viewMode: 'years'});
		}
		/* ./bootstrap datepicker */
