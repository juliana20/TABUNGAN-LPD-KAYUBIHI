...
<body>
    ...
    <h5 align="center">
      <u>Bukti Pembayaran Samsat Kendaraan</u>
    </h5>
      ...
      <table>
        <thead>
          <tr>
            ...
            <td style="width: 3%">:</td>
            <td>{{ @$item->kode_transaksi_samsat }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="width: 3%">:</td>
            <td>{{ date('d M Y', strtotime($item->tanggal_samsat)) }}</td>
          </tr>
          <tr>
            <td style="width: 35%">Tanggal Lunas</td>
            <td style="width: 3%">:</td>
            <td>{{ date('d M Y', strtotime($item->tanggal_lunas)) }}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="width: 35%">Jumlah Tagihan</td>
            <td style="width: 3%">:</td>
          ...
          <tr>
            <td style="width: 35%"><strong>Total Bayar</strong></td>
            <td style="width: 3%"><strong>:</strong></td>
            <td><strong>Rp. {{ number_format($item->total_bayar, 0) }}</strong></td>
          </tr>
        </thead>
      </table>
      <br>
