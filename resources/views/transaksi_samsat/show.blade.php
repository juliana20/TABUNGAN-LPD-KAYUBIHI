      ...
      <div class="box-body">
        ...
        <form  method="POST" action="{{ url($submit_url) }}" class="form-horizontal" name="form_crud">
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <label class="control-label">: {{ $item->kode_transaksi_samsat }}</label>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Plat Nomor Kendaraan</label>
            <div class="col-lg-9">
              <label class="control-label">: {{ @$item->plat_nomor }}</label>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Tanggal Transaksi</label>
            <div class="col-lg-9">
              <label class="control-label">: {{ date('d-m-Y', strtotime($item->tanggal_samsat)) }}</label>
            </div>
          </div>
          <div class="form-group">
