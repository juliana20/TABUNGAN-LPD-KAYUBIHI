    ...
    <div class="box-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          : <label for="exampleInputEmail1">{{ number_format(@$item->sisa_pinjaman * @$item->bunga_pinjaman, 2) }}</label>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="exampleInputEmail1">Sisa Pinjaman</label>
          : <label for="exampleInputEmail1">{{ number_format(@$item->sisa_pinjaman, 2) }}</label>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control mask-number calculate" name="f[bunga]" id="bunga" value="{{ ($item->lunas == 1) ? 0 : round(@$item->sisa_pinjaman * @$item->bunga_pinjaman) }}" placeholder="Bunga" required="" >
        </div>
      </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          @php $total = round((@$item->jumlah_pinjaman / @$item->jangka_waktu) + (@$item->sisa_pinjaman * @$item->bunga_pinjaman)); @endphp
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          @php $sisa_pinjaman = (@$item->sisa_pinjaman) - $total @endphp
