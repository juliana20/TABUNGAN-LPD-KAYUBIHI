...
<div class="box">
  <div class="box-body">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control mask-number" name="f[nominal_bunga]" id="nominal_bunga" value="{{ @$item->nominal_bunga * @$item->jangka_waktu }}"  required="" readonly>
        </div>
      </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label for="exampleInputEmail1">Sisa Bunga</label>
        <div class="input-group">
          <div class="input-group-btn">
            <span class="btn btn-default btn-flat">Rp</span>
          </div>
          <input type="text" class="form-control mask-number" name="f[sisa_bunga]" id="sisa_bunga" value="{{ ( @$item->nominal_bunga * @$item->jangka_waktu) - @$jumlah_bunga_sudah_dibayar }}"  required="" readonly>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          @php 
            $bunga = (@$item->nominal_bunga * @$item->jangka_waktu) - @$jumlah_bunga_sudah_dibayar; 
