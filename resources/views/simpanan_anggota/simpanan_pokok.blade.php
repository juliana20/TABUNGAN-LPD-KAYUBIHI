  ...
  <div class="box-body">
    <div class="col-md-6">
      <div class="form-group">
          ...
          <div class="col-lg-9">
            : <label class="control-label">{{ @$item->no_rek_sim_pokok }}</label>
          </div>
      </div>
      <div class="form-group">
      ...
      let lookup = {
        lookup_modal_setoran: function() {
            $('.modalSetoran').on( "click", function(e){
              ...
              _prop= {
                  _this : $( this ),
                  remote : "{{ url("$nameroutes") }}/lookup_form_setoran_pokok?id_nasabah=" + id_nasabah,
                  size : 'modal-md',
          ...
          lookup_modal_penarikan: function() {
            $('.modalPenarikan').on( "click", function(e){
              ...
              _prop= {
                  _this : $( this ),
                  remote : "{{ url("$nameroutes") }}/lookup_form_setoran_pokok_penarikan?id_nasabah=" + id_nasabah,
                  size : 'modal-md',
