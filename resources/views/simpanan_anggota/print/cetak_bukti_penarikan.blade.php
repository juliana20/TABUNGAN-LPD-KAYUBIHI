    ...
    <div class="container">
      ...
      <table>
        <thead>
          ...
          <tr>
            <td style="width: 25%">Saldo Simpanan</td>
            <td style="width: 3%">:</td>
            <td>{{ 'Rp ' .number_format(@$saldo_wajib + @$saldo_pokok, 2)  }}</td>
          </tr>
          <tr>
            <td style="width: 25%">Biaya Admin</td>
            <td style="width: 3%">:</td>
            <td>{{ 'Rp ' .number_format(@$biaya_admin, 2)  }}</td>
          </tr>
          <tr>
            <td style="width: 25%">Saldo Akhir</td>
            <td style="width: 3%">:</td>
            <td>{{ 'Rp ' .number_format((@$saldo_wajib + @$saldo_pokok) - @$biaya_admin, 2) }}</td>
          </tr>
        </thead>
      </table>
      <br>
