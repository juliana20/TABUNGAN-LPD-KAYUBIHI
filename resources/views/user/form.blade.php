<form  method="POST" action="{{ url($submit_url) }}" class="form-horizontal" name="form_crud">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-9">
      <input type="text" class="form-control" name="f[id_user]" id="id_user" value="{{ @$item->id_user }}" placeholder="ID User" required="" readonly>
    </div>
  </div>
  <div class="form-group">
      <label class="col-lg-3 control-label">Nama *</label>
      <div class="col-lg-9">
        <input type="text" class="form-control" name="f[nama_user]" id="nama_user" value="{{ @$item->nama_user }}" placeholder="Nama User" required="">
      </div>
  </div>
  <div class="form-group">
