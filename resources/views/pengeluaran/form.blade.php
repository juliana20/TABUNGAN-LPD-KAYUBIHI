  ...
  <div class="box-body">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <div>
            <button title="Tambah" id="lookup_detail" class="btn btn-info btn-block btn-github"><i class="fa fa-plus" aria-hidden="true"></i> <b>Tambah Detail Pengeluaran</b> </button>
        </div>
  </div>
  <br>
