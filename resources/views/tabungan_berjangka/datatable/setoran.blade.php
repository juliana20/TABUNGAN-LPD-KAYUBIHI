              ...
              columns: [
                          ...
                          { 
                                ...
                                render: function ( val, type, row ){
                                    ...
                                    if(row.proses == 1)
                                    {
                                      buttons += '<a href=\"{{ url('tabungan-berjangka/proses-setoran') }}/'+ val +'\" title=\"Lihat\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-eye\"></i> Lihat</a>';
                                    }else{
                                      buttons += '<a href=\"{{ url('tabungan-berjangka/proses-setoran') }}/'+ val +'\" title=\"Proses\" class=\"btn btn-success btn-xs\"><i class=\"fa fa-handshake-o\"></i> Proses</a>';
                                    }
                                      buttons += "</div>";
                                    return buttons
                                  }
