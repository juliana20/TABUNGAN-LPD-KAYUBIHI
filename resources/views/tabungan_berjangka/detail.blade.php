...
@section('content')  
  <div class="box">
    ...
    <div class="box-body" id="proses0">
      ...
      <div class="col-md-3">
        <div class="form-group">
          <label for="exampleInputEmail1">Denda Pinalti</label>
          <input type="text" class="form-control mask-number" name="f[denda_pinalti]" id="denda_pinalti" value="{{ @$item->denda_pinalti }}" required="" readonly>
        </div>
      </div>
    </div>  
